    ...
    : describe("Raffle Unit Test", function () {
          ...
          describe("constructor", function () {
              it("Initializes de raffle correctly", async function () {
                  // Ideally, we have only 1 assert per it
          ...
          describe("enterRaffle", function () {
              ...
              it("Doesn't allow entrance when raffle is calculating", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  // Documentation can be found in https://hardhat.org/hardhat-network/reference
          ...
          describe("checkUpkeep", function () {
              it("Returns false if people haven't sent any ETH", async function () {
                  ...
                  // With callstatic, I simulate calling the transaction and see what it'd have responded
          ...
          describe("performUpkeep", function () {
              it("It can only run if checkupkeep is true", async function () {
                  ...
                  assert(tx) // if performUpkeep failed, tx = false
              })
